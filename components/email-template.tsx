...
export const EmailTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
  ...
  <div className="font-sans text-gray-800 p-6">
    ...
    />
    <h1 className="text-blue-600 text-3xl mb-4">Welcome, {firstName}!</h1>
    <p className="text-base leading-7 mb-4">
      ...
      insights on coding, engineering practices, and career development straight
      to your inbox.
    </p>
    <p className="text-base leading-7 mb-4">
      Whether you're looking to elevate your skills, stay updated with industry
      trends, or take your career to the next level, you're in the right place.
    </p>
    <p className="text-base leading-7 mb-6">
      Stay tuned for exciting content, and don’t hesitate to reach out if you
      have any questions or topics you'd like me to cover.
    </p>
    <a
