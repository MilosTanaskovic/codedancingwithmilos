      ...
      <div className="py-8">
        <div className="text-center md:flex md:items-center md:justify-between">
          ...
          <ul className="inline-flex mb-4 md:order-1 md:ml-4 md:mb-0 space-x-2">
            <li>
              <a
                className="flex justify-center items-center text-cdwmcp-blue hover:text-cdwmcp-blue-10 transition duration-150 ease-in-out"
                href="https://x.com/CodeDancing"
                target="_blank"
                aria-label="Twitter"
              >
            ...
            <li>
              <a
                className="flex justify-center items-center text-cdwmcp-blue hover:text-cdwmcp-blue-10 transition duration-150 ease-in-out"
                href="https://github.com/MilosTanaskovic"
                target="_blank"
                aria-label="Github"
              >
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Copyright */}
          <div className="text-sm text-slate-500 dark:text-slate-400">Copyright © CodeDancingwithMilos. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )
