...
import Sidebar from "./sidebar-provider";
...
export const metadata = {
  ...
  keywords:
    "software engineering, software engineer, JS and .NET platform, JavaScript Ecosystem, .NET Ecosystem, programming skills, software development, tech leadership, engineering communication, tech career growth, developer training, code mastery, software projects",
  robots: "index, follow",
  author: "CodeDancingwithMilos",
  og: {
    title: "CodeDancingwithMilos - Master Software Engineering",
    description:
      "Take your software engineering skills to the next level. Learn to lead, code, and communicate like a senior engineer. Start your journey to becoming a top tech professional at CodeDancingwithMilos.",
    url: "https://codedancingwithmilos.com",
    type: "website",
    image: "https://codedancingwithmilos.com/images/codedancingwithmilos.png",
    site_name:
      "CodeDancingwithMilos - Become the Best Software Engineer on Your Team", // Adds consistency by specifying the website name.
  },
  twitter: {
    card: "summary_large_image",
    site: "@CodeDancing",
    title:
      "CodeDancingwithMilos - Become the Best Software Engineer on Your Team",
    description:
      "Sharpen your coding, leadership, and communication skills at CodeDancingwithMilos, and accelerate your career to senior-level software engineering.",
  ...
  schema: {
    ...
    description:
      "CodeDancingwithMilos is a learning platform dedicated to helping developers think and work like senior software engineers by enhancing coding, leadership, and communication skills.",
    sameAs: [
